...
{  
  if (Serial.available() > 0)
  {
    ...
    directionB = buffer1[4] - 48;
    directionB = directionB % 2;
    
    angleA = ((buffer1[1] - 48)*100) + ((buffer1[2] - 48)*10) + (buffer1[3] - 48);
    angleB = ((buffer1[5] - 48)*100) + ((buffer1[6] - 48)*10) + (buffer1[7] - 48);
    
    stepA = angleA/degreesPerStep;
    stepB = angleB/degreesPerStep;
